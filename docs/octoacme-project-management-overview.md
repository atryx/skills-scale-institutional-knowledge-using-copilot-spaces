...
- UX Designer: researches user needs, designs interfaces, validates solutions.
...
For detailed responsibilities and interaction models, see [Roles and Personas](octoacme-roles-and-personas.md).
